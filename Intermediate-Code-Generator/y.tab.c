...
static const yytype_uint16 yyrline[] =
{
     ...
     102,   106,   107,   110,   118,   119,   122,   130,   131,   135,
     148,   146,   172,   176,   177,   178,   179,   180,   181,   182,
     183,   187,   188,   189,   190,   191,   192,   193,   194,   195,
     199,   199,   199,   199,   203,   209,   220,   227,   230,   233,
     241,   258,   262,   266,   267,   268,   272,   288,   289,   290,
     294,   295,   296,   297,   298,   299,   300,   301,   302,   303,
     304,   308,   312,   313,   317,   321,   337,   338,   342,   346,
     350,   354,   358,   365,   366,   370,   378,   379,   383,   387,
     394,   395,   396,   397,   398,   399,   400,   401,   402,   403,
     404,   405,   406,   407,   408,   409,   410,   414,   418,   423,
     427,   428,   429,   433,   434,   435,   436,   437,   438,   439,
     440,   441,   446,   451,   455,   459,   465,   474,   484,   497,
     507,   518,   538,   561,   565,   575,   588,   593,   599,   599,
     610,   610,   621,   621,   632,   632,   646,   662,   671,   675,
     676,   680
};
#endif
...
#line 152 "parser.y" /* yacc.c:1646  */
    {          
                                    ...
                                    strcat(funcType, datatype);
                                    if(!node) {
                                        symbol_node_t *node = symbol_table_insert(symbol_table,(yyvsp[-5].char_ptr), curr_scope->scope_num, funcType, "", yylineno);
                                        node->num_params = num_params;
                                    }
                                    else {
...
#line 241 "parser.y" /* yacc.c:1646  */
    {
                                                                ...
                                                                curr_buff = get_new_node(TAC_code);
                                                                push_stack(three_address_code_stack, (yyvsp[-2].char_ptr));
...
#line 396 "parser.y" /* yacc.c:1646  */
    {push_stack(three_address_code_stack, (yyvsp[0].char_ptr));symbol_table_insert(constant_table, (yyvsp[0].char_ptr), -1, "int", "", yylineno); trace("CONSTANT_INTEGER\n");}
#line 2049 "y.tab.c" /* yacc.c:1646  */
    break;

  case 93:
#line 397 "parser.y" /* yacc.c:1646  */
    {push_stack(three_address_code_stack, (yyvsp[0].char_ptr));symbol_table_insert(constant_table, (yyvsp[0].char_ptr), -1, "float", "", yylineno); trace("CONSTANT_FLOAT\n");}
#line 2055 "y.tab.c" /* yacc.c:1646  */
    break;

  case 94:
#line 398 "parser.y" /* yacc.c:1646  */
    {push_stack(three_address_code_stack, (yyvsp[0].char_ptr));symbol_table_insert(constant_table, (yyvsp[0].char_ptr), -1, "char", "", yylineno); trace("CONSTANT_CHAR\n");}
#line 2061 "y.tab.c" /* yacc.c:1646  */
    break;

  case 95:
#line 399 "parser.y" /* yacc.c:1646  */
    {push_stack(three_address_code_stack, (yyvsp[0].char_ptr));symbol_table_insert(constant_table, (yyvsp[0].char_ptr), -1, "string", "", yylineno); trace("CONSTANT_STRING\n");}
#line 2067 "y.tab.c" /* yacc.c:1646  */
    break;

  case 96:
#line 400 "parser.y" /* yacc.c:1646  */
    {push_stack(three_address_code_stack, (yyvsp[0].char_ptr)); scope_error_check((yyvsp[0].char_ptr));trace("Primary Identifier\n");}
#line 2073 "y.tab.c" /* yacc.c:1646  */
    break;

  case 97:
#line 401 "parser.y" /* yacc.c:1646  */
    {push_stack(three_address_code_stack, (yyvsp[0].char_ptr)); scope_error_check((yyvsp[0].char_ptr));trace("Pointer Identifier\n");}
#line 2079 "y.tab.c" /* yacc.c:1646  */
    break;

  case 98:
#line 402 "parser.y" /* yacc.c:1646  */
    {push_stack(three_address_code_stack, (yyvsp[0].char_ptr)); scope_error_check((yyvsp[0].char_ptr));trace("Address of Identifier\n");}
